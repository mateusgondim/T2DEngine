...
public:
	...
	Animation_state(const std::string & name, const tgs::Animation_player & anim_player) : m_name(name), m_animation_player(anim_player) {}
...
private:
	...
	std::string											  m_name;
	tgs::Animation_player								  m_animation_player;
