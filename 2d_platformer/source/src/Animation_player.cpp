...
tgs::Animation_player::Animation_player(const std::vector<Animation> & animations) : m_animations(animations), m_current_animation(0), m_playing(true), m_current_frame(-1), m_local_clock(0.0f)
{
...
void tgs::Animation_player::update(const float dt) 
{	
	if (m_playing) {
