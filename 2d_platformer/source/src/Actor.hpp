...
public:
	Actor(const cgm::vec3 & pos, const cgm::mat4 & orientation, Gameplay_state *pstate, const AABB_2d & aabb, const cgm::vec2 & velocity, const std::string & texture_file, const float pixels_per_unit = 16, bool facing_left = true);
	...
	Actor(const AABB_2d & aabb, const cgm::vec2 & velocity, const std::string & texture_file, const float pixels_per_unit = 16, bool facing_left = true);
