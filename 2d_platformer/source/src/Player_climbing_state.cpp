...
Gameplay_state * Player_climbing_state::check_transition(Actor & actor) 
{
	...
	bool is_on_ladder_top = g_physics_manager.get_world()->is_on_ladder_top_tile(actor.get_body_2d(), bounds);
	bool is_on_ground = g_physics_manager.get_world()->is_body_2d_on_ground(actor.get_body_2d());
