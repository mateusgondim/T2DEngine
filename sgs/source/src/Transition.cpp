...
void Transition::add_boolean_condition(const std::string & param_name, const bool bcomp_value)
{
	m_upconditions.push_back(std::make_shared<Bool_condition>(param_name, bcomp_value));
}

void Transition::add_trigger_condition(const std::string & param_name)
{
