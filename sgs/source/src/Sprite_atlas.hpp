...
namespace tgs {
	...
	public:
		...
		void get_text_coord(const int sprite_no, Rect * prect, float * px_width, float *px_height) const;
	private:
		...
		cgm::vec2			m_image_size; // width and height of this sprite in pixels
		std::vector<Rect>	m_vrec;		  // pixel coordinates of each sprite on the texture atlas
