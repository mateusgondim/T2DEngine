...
public:
	Tileset() = default;
	Tileset(Tile * ptiles, const int  first_gid, string_id & texture_id, const int tile_width, const int tile_height, const int margin, const int spacing, const int tile_count, const int columns, const int set_width, const int set_height)
		: m_ptiles(ptiles), m_first_gid(first_gid), m_texture_id(texture_id), m_tile_width(tile_width), m_tile_height(tile_height), m_margin(margin), m_spacing(spacing),
