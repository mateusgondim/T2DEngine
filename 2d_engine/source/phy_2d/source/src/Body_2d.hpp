...
namespace physics_2d {
	...
	public:
		...
		math::vec2			get_position()      const { return m_position;}
		math::vec2        &  get_position()			  { return m_position; }
		math::vec2			get_velocity()      const { return m_velocity;}
		math::vec2			get_acceleration()  const { return m_acceleration;}
		...
		void                set_velocity(const math::vec2 vel) { m_velocity = vel; }
