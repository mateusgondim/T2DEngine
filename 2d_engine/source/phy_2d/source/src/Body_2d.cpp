...
namespace physics_2d {
	...
	Body_2d::Body_2d(const Body_2d_def *pbody_def) :
		m_type(pbody_def->m_type), m_position(pbody_def->m_position), m_velocity(pbody_def->m_velocity), m_mass(pbody_def->m_mass), m_aabb(pbody_def->m_aabb), m_acceleration(pbody_def->m_acceleration),
