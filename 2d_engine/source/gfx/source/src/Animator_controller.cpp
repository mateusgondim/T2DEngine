...
void gfx::Animator_controller::add_state(const Animation_state & anim_state)
{ 
...
void gfx::Animator_controller::set_initial_state(const std::string & name)
{
...
void gfx::Animator_controller::set_int(const std::string & name, const int ivalue)
{
...
void gfx::Animator_controller::set_bool(const std::string & name, const bool bvalue)
{
...
void gfx::Animator_controller::set_trigger(const std::string & name)
{
...
bool gfx::Animator_controller::get_trigger(const std::string & name) const
{
	auto iter = m_trigger_parameters.find(name);
	if (iter == m_trigger_parameters.end()) {
...
void gfx::Animator_controller::add_int_condition(const std::string & t_name, const std::string & param_name, Condition::Cond_operator op, const int expected_value)
{
...
void gfx::Animator_controller::add_bool_condition(const std::string & t_name, const std::string & param_name, const bool expected_value)
{
	auto iter = m_transitions.find(t_name);
	if (iter != m_transitions.end()) {
...
void gfx::Animator_controller::add_trigger_condition(const std::string & t_name, const std::string & param_name, const bool expected_value)
{
...
unsigned gfx::Animator_controller::get_current_frame() const
{
	auto iter = m_state_machine.find(m_current_state);
...
gfx::Animation_state & gfx::Animator_controller::get_current_state()
{
	auto iter = m_state_machine.find(m_current_state);
	if (iter != m_state_machine.end()) {
		return (iter->second);
...
unsigned gfx::Animator_controller::get_current_anim() const
{
	auto iter = m_state_machine.find(m_current_state);
	if (iter != m_state_machine.end()) {
...
void gfx::Animator_controller::switch_curr_state_anim_clip(const std::vector<Animation>::size_type next_anim)
{
	auto iter = m_state_machine.find(m_current_state);
	if (iter != m_state_machine.end()) {
