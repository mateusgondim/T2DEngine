...
void gfx::Animation_state::update(const float dt)
{
	m_animation_player.update(dt);
}
/*
...
std::ostream & gfx::operator<<(std::ostream & os, const Animation_state & anim_state)
{
...
bool gfx::operator==(const Animation_state & lhs, const  Animation_state & rhs)
{
