...
gfx::Sprite::Sprite(const Sprite_atlas *patlas, const std::uint8_t layer, const float pixels_per_unit) : m_patlas(patlas), m_layer(layer) ,m_pixels_per_unit(pixels_per_unit), m_is_active(true)
{
