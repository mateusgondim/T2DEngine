...
namespace level_management
{
    ...
    void Level_manager::init()
    {
        ...
        control_scheme.map_action_to_button(SID('reset_level'), io::Abstract_keyboard_index::KEY_R);
    ...
    void Level_manager::tick()
    {
       ...
       //std::cout << "FRAME TIME: " << m_timer.get_dt() << std::endl;
        ...
        float game_delta_time_seconds = Timer::cycles_to_seconds(
            m_timer.get_time_cycles() - last_game_time_cycles);
