...
namespace ui
{
        ...
        private:
                Text(Canvas & parent_canvas, const math::Rect &, const std::string & msg,
                     const float scale_factor = 1.0f, const int characters_space = 1,
                     const int space_character_sz = 6);
