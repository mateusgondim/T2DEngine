...
namespace gom {
	...
	public:
            Camera_2d() = default;
            Camera_2d(float tile_width_wld, float tile_height_wld, float tiles_per_screen_width,
                      float tiles_per_screen_height, int map_width, int map_height,
                      const math::vec2 & map_wld_origin = math::vec2());

		void init(float tile_width_wld, float tile_height_wld, float tiles_per_screen_width,
                  float tiles_per_screen_height, int map_width, int map_height,
                  const math::vec2 & map_wld_origin = math::vec2());
		...
		bool		   is_off_camera(const math::vec3 & pos, const float width,
